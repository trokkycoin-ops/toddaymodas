        ...
        return new WP_REST_Response([
            ...
            'data' => [
                ...
                'melhorenvio' => [
                    ...
                    'has_webhook_secret' => !empty($me['webhook_secret']),
                ],
                'whatsapp' => [
    ...
    public static function save_settings(WP_REST_Request $request): WP_REST_Response {
        ...
        if (isset($params['mercadopago'])) {
            ...
            $new_mp = [
                ...
                'access_token' => !empty($params['mercadopago']['access_token'])
                    ...
                    : ($mp['access_token'] ?? ''),
                'webhook_secret' => sanitize_text_field($params['mercadopago']['webhook_secret'] ?? $mp['webhook_secret'] ?? ''),
            ];
        ...
        if (isset($params['melhorenvio'])) {
            ...
            $new_me = [
                ...
                'webhook_secret' => sanitize_text_field($params['melhorenvio']['webhook_secret'] ?? $me['webhook_secret'] ?? ''),
