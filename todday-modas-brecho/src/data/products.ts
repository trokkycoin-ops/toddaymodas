import { Product, ThriftCondition } from '../types';

export const INITIAL_PRODUCTS: Product[] = [
  {
    id: 100,
    name: 'Vestido Maxi Luciana Pais Azul Estampa Exclusiva Ref: 94524',
    slug: 'vestido-maxi-luciana-pais-azul-estampa-exclusiva-94524',
    price: 382.31,
    regular_price: 499.80,
    category: 'Moda Feminina (Adulto)',
    condition: 'Seminovo Impecável',
    size: 'P (38)',
    available_sizes: ['PP (36)', 'P (38)', 'M (40)', 'G (42)', 'GG (44)', 'XG (46)'],
    color: 'Azul Estampa Exclusiva',
    available_colors: [
      { name: 'Azul Floral Exclusivo', hex: '#2B5B84', in_stock: true },
      { name: 'Lavanda Suave', hex: '#dac9df', in_stock: true },
      { name: 'Off-White Botânico', hex: '#F7F4EF', in_stock: true }
    ],
    ...
    description: 'Vestido longo maxi de alta costura assinado pela prestigiada grife Luciana Pais (Referência 94524). Modelagem evasê fluida com caimento modesto impecável, estampa floral botânica exclusiva sobre fundo azul imperial, decote em V sutil com fechamento recatado e mangas com elástico delicado. Acompanha cinto forrado no mesmo tecido nobre da peça para ajuste elegante na cintura.',
    measurements: {
      bust: '98 cm',
  ...
  },
  {
    ...
    condition: 'Seminovo Impecável',
    size: 'M (40)',
    available_sizes: ['PP (36)', 'P (38)', 'M (40)', 'G (42)', 'GG (44)'],
    color: 'Lavanda Suave com Floral Botânico',
    available_colors: [
      { name: 'Lavanda Suave', hex: '#dac9df', in_stock: true },
      { name: 'Verde Esmeralda Botânico', hex: '#0F4C3A', in_stock: true },
      { name: 'Pérola Off-White', hex: '#F7F4EF', in_stock: true }
    ],
    brand: 'Fascínius Haute Couture Modesta',
    fabric: 'Crepe Georgette Acetinado com Forro Antialérgico',
    care_instructions: 'Higienização profissional com vaporização delicada. Lavagem a seco ou manual suave.',
  ...
  },
  {
    ...
    available_sizes: ['Padrão Médio (25x18x5cm)', 'Grande / Thompson (27x20x6cm)'],
    color: 'Lilás Orquídea Clássico',
    available_colors: [
      { name: 'Lilás Orquídea', hex: '#dac9df', in_stock: true },
      { name: 'Verde Floresta & Ouro', hex: '#165B4C', in_stock: true },
      { name: 'Preto Nobre Imperial', hex: '#1A1A1A', in_stock: true }
    ],
  ...
  },
  {
    ...
    available_sizes: ['45 cm + 5 cm Extensor', '55 cm Solene'],
    color: 'Dourado 18k com Cristal',
    available_colors: [
      { name: 'Dourado 18k Cristal', hex: '#D4AF37', in_stock: true },
      { name: 'Ouro Branco & Lilás', hex: '#dac9df', in_stock: true },
      { name: 'Esmeralda Colonial', hex: '#0F4C3A', in_stock: true }
    ],
  ...
  },
  {
    ...
    condition: 'Seminovo Impecável',
    size: '4 a 6 Anos',
    available_sizes: ['2 a 4 Anos', '4 a 6 Anos', '6 a 8 Anos'],
    color: 'Lilás Pastel e Verde Sage',
    available_colors: [
      { name: 'Lilás & Branco Neve', hex: '#dac9df', in_stock: true },
      { name: 'Verde Menta Suave', hex: '#A3B899', in_stock: true },
      { name: 'Rosa Chá Delicado', hex: '#F4C2C2', in_stock: true }
    ],
  ...
  },
  {
    ...
    available_colors: [
      { name: 'Azul Céu Nobre', hex: '#87CEEB', in_stock: true },
      { name: 'Verde Botânico Oliva', hex: '#2D6A4F', in_stock: true },
      { name: 'Branco Puro Egípcio', hex: '#FFFFFF', in_stock: true },
      { name: 'Preto Clássico', hex: '#1A1A1A', in_stock: true }
    ],
    brand: 'Dudalina Alfaiataria Masculina',
    fabric: '100% Algodão Fio Egípcio 120/2 Pima',
    care_instructions: 'Higienização a vapor. Tecido com tecnologia de fácil passadoria.',
  ...
  },
  {
    ...
    condition: 'Seminovo Impecável',
    size: '37',
    available_sizes: ['34', '35', '36', '37', '38', '39', '40'],
    color: 'Nude Rosado Fosco',
    available_colors: [
      { name: 'Nude Rosado Suave', hex: '#E8D3C6', in_stock: true },
      { name: 'Lilás Lavanda Clássico', hex: '#dac9df', in_stock: true },
      { name: 'Verde Esmeralda Nobre', hex: '#0F4C3A', in_stock: true },
      { name: 'Preto Verniz', hex: '#111111', in_stock: true }
    ],
  ...
  },
  {
    ...
    size: 'G (Veste 42-44)',
    available_sizes: ['M (38-40)', 'G (42-44)', 'GG (46)'],
    color: 'Verde Esmeralda Botânico & Alfazema',
    available_colors: [
      { name: 'Verde Esmeralda Botânico', hex: '#0F4C3A', in_stock: true },
      { name: 'Lilás Alfazema Suave', hex: '#dac9df', in_stock: true },
      { name: 'Bordeaux Marsala Nobre', hex: '#581845', in_stock: true }
    ],
  ...
  },
  {
    ...
    condition: 'Seminovo Impecável',
    size: '6 Anos',
    available_sizes: ['4 Anos', '6 Anos', '8 Anos'],
    color: 'Camisa Branca & Bermuda Verde Oliva',
    available_colors: [
      { name: 'Branco & Verde Militar Suave', hex: '#3E5C43', in_stock: true },
      { name: 'Branco & Bege Areia', hex: '#D2B48C', in_stock: true },
      { name: 'Branco & Lilás Alfazema', hex: '#dac9df', in_stock: true }
    ],
  ...
  },
  {
    ...
    available_sizes: ['18 cm + 3 cm Ajustável'],
    color: 'Prata 925 com Zircônias',
    available_colors: [
      { name: 'Prata & Lilás Suave', hex: '#dac9df', in_stock: true },
      { name: 'Prata & Verde Esmeralda', hex: '#0F4C3A', in_stock: true },
      { name: 'Prata Pura Clássica', hex: '#C0C0C0', in_stock: true }
    ],
  ...
  },
  {
    ...
    available_colors: [
      { name: 'Café Profundo Envernizado', hex: '#3B2219', in_stock: true },
      { name: 'Preto Nobre Oxford', hex: '#111111', in_stock: true },
      { name: 'Pinhão Acetinado', hex: '#4A2A20', in_stock: true }
    ],
  ...
  },
  {
    ...
    available_colors: [
      { name: 'Pérola Off-White', hex: '#F8F6F0', in_stock: true },
      { name: 'Verde Salva Botânico', hex: '#165B4C', in_stock: true },
      { name: 'Lilás Orquídea Clássico', hex: '#dac9df', in_stock: true }
    ],
  ...
  },
  {
    ...
    available_colors: [
      { name: 'Lilás Lavanda Pastel', hex: '#dac9df', in_stock: true },
      { name: 'Verde Esmeralda Imperial', hex: '#0F4C3A', in_stock: true },
      { name: 'Dourado Champagne', hex: '#E5C158', in_stock: true }
    ],
  ...
  },
  {
    ...
    condition: 'Seminovo Impecável',
    size: '42',
    available_sizes: ['38', '40', '42', '44', '46', '48'],
    color: 'Azul Marinho Nobre',
    available_colors: [
      { name: 'Azul Marinho Nobre', hex: '#1E293B', in_stock: true },
      { name: 'Preto Clássico Solene', hex: '#111827', in_stock: true },
      { name: 'Cinza Chumbo Grafite', hex: '#475569', in_stock: true },
      { name: 'Bege Areia Fino', hex: '#D2B48C', in_stock: true }
    ],
...
export const CONDITIONS: ThriftCondition[] = [
  'Novo com Etiqueta',
  'Seminovo Impecável',
  'Peça Única Selecionada',
  'Vintage Especial'
];
